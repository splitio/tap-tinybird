...
from tap_tinybird.discover import discover_streams
from tap_tinybird.sync import sync_stream
from tap_tinybird.config import CONFIG_CONTRACT

LOGGER = singer.get_logger()

REQUIRED_CONFIG_KEYS = ["start_date", "tinybird_access_token", "tinybird_api_url"]
